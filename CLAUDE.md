...
- [x] Unit tests for engine math (23 tests in `src/engine.rs`)
- [x] Unit tests for state tracking (33 tests in `src/state.rs`)
- [x] README with setup/run instructions
- [x] Config examples (`config.toml.template` already adequate)
- [x] Final testing with real trader
